...
public class PunchAdjustTest {
    ...
    @Test
    public void testRoundIntervalBeforeShiftStart() {
        ...
        assertEquals("#3282F212 CLOCK IN: MON 09/17/2018 06:44:03", p1.printOriginal());
        assertEquals("#3282F212 CLOCK IN: MON 09/17/2018 06:45:00 (Interval Round)", p1.printAdjusted());
    }
    ...
    public void testAdjustPunchesShift2SpecialCases() {
        ...
        assertEquals("#28DC3FB8 CLOCK IN: WED 09/12/2018 06:47:32", p1.printOriginal());
        assertEquals("#28DC3FB8 CLOCK IN: WED 09/12/2018 07:00:00 (Shift Start)", p1.printAdjusted());
